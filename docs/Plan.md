...
| Задача |    Дата    | 
|:---------------|:----------:|  
| Планирование автоматизации тестирования          | 15.03.2023 |
| Написание автотестов        | 15.03.2023 |
| Подготовка отчётных документов по итогам автоматизированного тестирования         | 19.03.2023 |
| Подготовка отчётных документов по итогам автоматизации        | 19.03.2023 |
